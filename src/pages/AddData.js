...
const AddRestitusi = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      const reqData = await axios.post(
        'http://sanctum-api.test/api/restitusi',
        form,
        {
          headers,
        }
  ...
  return (
    <Dashboard
      headerTitle='Tambah Data Restitusi'
      headerDesc='untuk menambah data baru Restitusi'
    >
      <div className='row mb-5 gy-5 gx-xl-10 flex-center'>
        <div className='col-7'>
          <div className='card card-xl-stretch mb-xl-10 pt-5'>
            <div className='card-body'>
              <form onSubmit={onSubmit} className='form'>
                <div className='d-flex flex-column mb-8 fv-row'>
                  <label className='d-flex align-items-center fs-6 fw-bold mb-2'>
                    <span className='required'>NPWP</span>
                  </label>
                  <InputMask
                    mask='999999999-999.999'
                    onChange={handleChange}
                    type='text'
                    className='form-control form-control-solid'
                    placeholder='000000000-111.000'
                    name='npwp'
                  />
                </div>
                <div className='d-flex flex-column mb-8 fv-row'>
                  <label className='d-flex align-items-center fs-6 fw-bold mb-2'>
                    <span className='required'>Nama Wajib Pajak</span>
                  </label>
                  <input
                    type='text'
                    className='form-control form-control-solid'
                ...
                <div className='d-flex flex-column mb-8 fv-row'>
                  <label className='d-flex align-items-center fs-6 fw-bold mb-2'>
                    <span className='required'>Nomor BPS</span>
                  </label>
                  <input
                    type='text'
                    className='form-control form-control-solid'
                ...
                <div className='row g-9 mb-8'>
                  <div className='col-md-6 fv-row'>
                    ...
                    >
                      ...
                      <option value={1}>Anju Frans S</option>
                      <option value={2}>Rini Amelia Simanjuntak</option>
                      <option value={3}>Stevic Beatrix Sinaga</option>
                      <option value={4}>Nurlaili Ramadhani</option>
                      <option value={5}>Christin Mei O. Nainggolan</option>
                    </select>
                  </div>
                  <div className='col-md-6 fv-row'>
                ...
                <div className='text-center'>
                  ...
                  <button type='submit' className='btn btn-primary'>
                    ...
                    <span className='indicator-progress disabled'>
                      Please wait...
